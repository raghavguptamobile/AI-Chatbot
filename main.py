...
def bot_response_function(user_message, chat_history):
    ...
    external_knowledge = """
    GQ Men's Fashion Magazines 2020 onwards
    """

    # 2. YOUR CODE HERE -  Give the LLM a prompt to respond to the user
    chatbot_prompt = f"""
    You are a digital fashion stylist who gives advice to customers

    respond to this {user_message} following these instructions:

    ## Instructions:
    * be very concise
    * Ground all your answers based on {external_knowledge} and make sure you cite the reference
    """
